  ...
  return (
    <section className="relative bg-black pt-16 md:pt-20 lg:pt-24 pb-20 md:pb-28 lg:pb-32 overflow-hidden" style={{ position: 'relative' }}>
      ...
      <div className="container z-10 mx-auto relative px-4 sm:px-6">
        ...
        {/* Grid com conteúdo */}
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 md:gap-10 lg:gap-12 xl:gap-16 items-start max-w-7xl mx-auto mt-12 md:mt-16 lg:mt-20 xl:mt-24">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative xl:-ml-16 2xl:-ml-32 px-4 md:px-6 lg:px-6 xl:pl-2 xl:-mt-2"
          >
