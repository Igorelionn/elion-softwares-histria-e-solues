...
export default function ConfirmadoPage() {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4 sm:px-6 py-8 sm:py-12 relative overflow-hidden">
      {/* Background gradiente simples - SEM ANIMAÇÃO */}
      <div className="absolute inset-0 bg-gradient-to-br from-black via-zinc-900 to-black" />

      {/* Ícone de Verificado - Posição Fixa no Topo - SEM MOTION */}
      ...
      >
        {/* Título - SEM MOTION INDIVIDUAL */}
        <div className="space-y-2 flex flex-col items-center justify-center py-3 sm:py-4 px-4">
        ...
        {/* Texto Descritivo - SEM MOTION INDIVIDUAL */}
        <div className="space-y-3 sm:space-y-4 text-white/70 leading-relaxed max-w-xl text-center -mt-2 sm:-mt-4 px-4">
        ...
        {/* Botão para voltar - SEM MOTION INDIVIDUAL */}
        <div className="pt-4 sm:pt-6 flex justify-center w-full px-4">
          <Button
            onClick={() => router.push("/")}
